...
class Author(PrimaryKeyMixin, NameMixin, TimestampMixin):
...
class Category(PrimaryKeyMixin, NameMixin, TimestampMixin):
    __tablename__ = "categories"


class Place(PrimaryKeyMixin, NameMixin, TimestampMixin):
    __tablename__ = "places"


class Format(PrimaryKeyMixin, NameMixin, TimestampMixin):
    __tablename__ = "formats"


class BookAuthor(PrimaryKeyMixin):
...
class BookCategory(PrimaryKeyMixin):
...
class BookFormat(PrimaryKeyMixin):
...
class BookPlace(PrimaryKeyMixin):
